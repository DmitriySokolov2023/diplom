                ...
                <Box sx={style}>
                    <Typography id="modal-modal-title" variant="h6" component="h2">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className={s.form} >
                            <TextField id="outlined-basic" {...register('login')} label="Логин" variant="outlined" />
                            <TextField id="outlined-basic" type={"password"} {...register('password')} label="Пароль" variant="outlined" />
