    ...
    return <>
        <div>
            <form onSubmit={handleSubmit(onSubmit)} className={s.form} >
                        ...
                        <TextField id="outlined-basic" {...register('title_spec')} label="Специальность" variant="outlined" />
                        <TextField id="outlined-basic" {...register('director')} label="Классный руководитель" variant="outlined" />
                        <TextField id="outlined-basic" {...register('date')} label="Год выпуска студентов" variant="outlined" />
                    ...
                    <TableBody>
                        {groups?.map(gr => (
                            <TableRow key={gr.id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                ...
                                <TableCell> {gr.title_spec}</TableCell>
                                <TableCell> {gr.director}</TableCell>
